...
export const webData: WebData = {
	...
	description:
		"Your designs? Too good to stay flat. Your creativity? Too powerful to be stuck in 2D. It's time to bring your vision to life—no fancy software, no tech skills, just pure creative power at your fingertips. Upload Your Design. Watch It Instantly Transform. Download & Dominate.",
	keywords: [
		'Suman',
		'Debnath',
		'Suman Debnath',
...
export const contents: WebContent = {
	...
	pricing: [
		['Unlimited mockups', 'No catch', 'Jump in now'],
		['Full 3D animations', 'High-res exports', 'Premium templates and more'],
	],
	...
	text12:
		"Your designs? Too good to stay flat. Your creativity? Too powerful to be stuck in 2D. It's time to bring your vision to life—no fancy software, no tech skills, just pure creative power at your fingertips. Upload Your Design. Watch It Instantly Transform",
	text13: 'Sign In',
...
export const socials: Socials = {
	...
	instagram: 'https://www.instagram.com/firstoxstudio_com',
	tiktok: 'https://www.tiktok.com/@firstoxstudio',
	blogs: '/blogs',
