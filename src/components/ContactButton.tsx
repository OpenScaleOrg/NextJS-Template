...
const ContactButton = () => {
    ...
    return (
        <>
            ...
            {active && (
                <div className='absolute top-[80px] left-0 w-full h-[calc(100vh-80px)] bg-main-background/50 backdrop-blur-sm flex justify-center items-center z-50' onClick={closeForm}>
                    <form className='flex flex-col md:min-w-[448px] max-w-[448px] md:mx-0 mx-5 w-full rounded-[24px] items-center justify-center md:p-8 p-8 text-main-foreground shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] outline backdrop-blur-[2px]' onSubmit={(e) => sendMessage(e)}>
