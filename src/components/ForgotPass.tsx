    ...
    return (
        <div className='w-full max-w-[1152px] flex items-center md:justify-center justify-center md:px-20 md:py-10 md:gap-10'>
            <div className='flex flex-col justify-start items-start w-full md:max-w-[560px]'>
                ...
                <Link rel="canonical" href={process.env.NEXT_PUBLIC_BASE_URL || '/'} className='flex items-center gap-2 md:gap-4 outline-none px-4 py-2 md:mt-8 rounded-[16px] bg-main-foreground'>
            ...
            {(() => {
                switch (step) {
                    case 1:
                        return (
                            <form className='flex flex-col max-w-[448px] md:w-[448px] rounded-[24px] items-center justify-center md:p-8 text-main-foreground shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] backdrop-blur-[2px]' onSubmit={(e) => verifyCode(e)}>
                                ...
                                <button type='submit' className='w-full bg-[linear-gradient(90deg,#3B82F6_0%,#A855F7_100%)] p-[10px] bg-primary text-background rounded-[10px] md:mt-5 text-[14px] font-medium flex justify-center items-center cursor-pointer cursor-pointer'>
                                    {
                                        spin ?
                    ...
                    case 2:
                        return (
                            <form className='flex flex-col max-w-[448px] md:w-[448px] rounded-[24px] items-center justify-center md:p-8 text-main-foreground shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] backdrop-blur-[2px]' onSubmit={(e) => resetPass(e)}>
                                <h2 className='font-bold text-[24px]'>
                                    Change Password
                                </h2>
                                <span className='text-[14px] md:mt-2'>Start your creative journey today</span>
                                ...
                                <button type='submit' className='w-full bg-[linear-gradient(90deg,#3B82F6_0%,#A855F7_100%)] p-[10px] bg-primary text-main-background rounded-[10px] md:mt-5 text-[14px] font-medium flex justify-center items-center cursor-pointer cursor-pointer'>
                                    {
                                        spin ?
                                            <div className="w-6 h-6 border-4 border-background border-t-transparent rounded-full animate-spin"></div>
                                            :
                                ...
                                <div className='flex justify-center items-center md:gap-2 w-full md:mt-5'>
                                    <span className="text-[14px] text-foreground">
                                        Already have an account? <Link href={'/signin'} className="text-blue-700 underline cursor-pointer">Sign In</Link>
                                    </span>
                                </div>
                            </form>
                        )
                    default:
                        return (
                            <form className='flex flex-col max-w-[448px] md:w-[448px] rounded-[24px] items-center justify-center md:p-8 text-main-foreground shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] backdrop-blur-[2px]' onSubmit={(e) => getCode(e)}>
                                <h2 className='font-bold text-[24px]'>
                                    Forgot Password
                                </h2>
                                <span className='text-[14px] md:mt-2'>Start your creative journey today</span>
...

            {
                ...
                <div className='absolute top-0 left-0 w-full h-screen flex justify-center items-center backdrop-blur-[4px]'>
                    <div className='md:h-[200px] md:w-[400px] flex flex-col justify-center items-center md:gap-5 bg-main-light/20 rounded-3xl md:p-20'>
                        ...
                        <Link href={'/signin'} className='font-black text-main-foreground hover:underline'>Go to Login</Link>
                    </div>
                </div>
            }
