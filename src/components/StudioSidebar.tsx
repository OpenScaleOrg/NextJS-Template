...
const StudioSidebar = ({ index, user }: { index: number; user: User }) => {
	return (
		<div className="fixed left-0 z-40 min-w-[260px] max-w-[260px] h-[calc(100vh-80px)] flex flex-col justify-between items-center gap-2 border-r-[1px] border-main-light/20 dark:border-main-light/10">
			<div className="w-full p-4 flex flex-col justify-start items-center">
				<Link
					href={'/studio'}
					type="button"
					className={`w-full h-[44px] md:p-4 md:gap-4 text-[14px] rounded-[12px] flex items-center cursor-pointer ${index == 0 ? 'bg-gradient-to-r from-[#3B82F6] to-[#A855F7] text-main-background dark:text-main-foreground' : 'text-main-light dark:text-main-foreground'}`}
				>
					{index == 0 ? (
				...
				<Link
					href={'/studio'}
					type="button"
					className={`w-full h-[44px] md:p-4 md:gap-4 text-[14px] rounded-[12px] flex items-center cursor-pointer ${index == 1 ? 'bg-gradient-to-r from-[#3B82F6] to-[#A855F7] text-main-background dark:text-main-foreground' : 'text-main-light dark:text-main-foreground'}`}
				>
					{index == 1 ? (
						<Image src={'/icons/home.svg'} height={20} width={20} alt="home" />
					) : (
				...
				<Link
					href={'/studio'}
					type="button"
					className={`w-full h-[44px] md:p-4 md:gap-4 text-[14px] rounded-[12px] flex items-center cursor-pointer ${index == 3 ? 'bg-gradient-to-r from-[#3B82F6] to-[#A855F7] text-main-background dark:text-main-foreground' : 'text-main-light dark:text-main-foreground'}`}
				>
					{index == 2 ? (
						<Image src={'/icons/home.svg'} height={20} width={20} alt="home" />
					) : (
			...
			<div className="w-full border-t-1 border-main-light/20 flex flex-col justify-start items-center">
				<button
					type="button"
					title="shirts"
					className={`w-full h-[60px] md:p-4 md:gap-4 text-[14px] rounded-[12px] flex items-center cursor-pointer`}
				>
