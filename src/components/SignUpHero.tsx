  ...
  return (
    ...
    <div className='w-full max-w-[1152px] flex flex-wrap md:flex-nowrap flex-col-reverse lg:flex-row items-center lg:justify-center justify-center md:px-20 md:py-10 md:gap-10 gap-2'>
      ...
      <div className='flex justify-center items-center w-full md:max-w-[448px] md:p-0 p-2.5'>
        <form className='flex flex-col md:min-w-[448px] md:w-[448px] rounded-[24px] items-center justify-center md:mx-0 mx-2.5 md:p-8 p-8 text-main-foreground shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] backdrop-blur-[2px]' onSubmit={(e) => submit(e)}>
          ...
          <div className="flex justify-start w-full items-center md:gap-2 gap-2 md:mt-5 mt-5">
            ...
            <label htmlFor="terms" className="text-[14px] text-foreground">
              I agree to <Link href={'/'} className="text-blue-700 underline cursor-pointer">Terms of Service</Link> and <Link href={'/'} className='text-blue-700 underline cursor-pointer'>Privacy Policy</Link>
            </label>
          </div>

          <button type='submit' className='w-full bg-[linear-gradient(90deg,#3B82F6_0%,#A855F7_100%)] p-[10px] bg-primary text-background rounded-[10px] md:mt-5 mt-5 text-[14px] font-medium flex justify-center items-center cursor-pointer'>
            {
              spin ?
