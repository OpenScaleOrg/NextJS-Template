...
function QNAElement({ question, answer }: QNAElementProps) {
	...
	return (
		<div className="w-full shadow-lg rounded-4xl bg-main-background px-8 py-4 mb-4">
			...
			>
				<span className="text-[16px] font-medium text-[#1a73e8]">
					Q: <span className="text-main-foreground font-bold ml-4">{question}</span>
				</span>
				...
				<>
					...
					<div className="py-4">
						<p className="text-[16px] font-medium text-green-600">
							A: <span className="text-[14px] font-normal text-main-light ml-4">{answer}</span>
						</p>
					</div>
				</>
			)}
