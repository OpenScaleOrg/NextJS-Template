  ...
  return (
    <main className="w-full flex flex-col items-center justify-start">
      ...
      <section className='w-full max-w-[1440px] flex flex-col items-center justify-center lg:px-20 px-5 md:py-10 '>
        <h3 className='md:text-[18px] sm:text-[16px] text-[12px] text-main-light md:mt-0 mt-10'>Professional mockup generator for designers and brands</h3>
        <div className='flex flex-col justify-start items-center md:mt-10 mt-10'>
          <h1 className='font-extrabold md:text-[52px] sm:text-[36px] text-[24px] text-main-foreground text-center sm:leading-[60px] md:mb-10'>
            Turn Your Apparel <br className='md:block hidden' /> Designs Into <br className='md:hidden block' /> Stunning <br className='md:block hidden' /> Mockups - <span className='bg-gradient-to-r from-[#2563EB] via-[#9333EA] to-[#DB2777] bg-clip-text text-transparent'>Instantly</span>
          </h1>
        </div>
        <p className='md:text-[18px] sm:text-[16px] text-[12px] text-main-light md:mt-10 mt-10 max-w-[600px] text-center'>Visualize your designs in ultra-realistic 3D and crisp 2D
          mockups. All in your browser. No downloads, No installation & No delays.
        </p>
      ...
      <section className='w-full max-w-[1440px] flex flex-col items-center justify-start lg:px-20 px-5 md:mt-40 sm:mt-40 mt-20'>
        <h2 className='text-main-foreground text-center font-extrabold md:text-[48px] sm:text-[36px] text-[24px]'>
          Why settle for still when you can have the <span className='bg-gradient-to-r from-[#BB2DAC] to-[#D9277A] bg-clip-text text-transparent'>movement?</span>
        </h2>
        <div className='flex flex-wrap justify-center items-center w-full md:gap-10 gap-5 md:mt-20 mt-20'>
          {contents.features.map((feature, index) => (
            <div key={index} className='flex flex-col rounded-[24px] dark:bg-main-foreground/20 dark:backdrop-blur-sm items-start justify-start gap-4 md:px-8 px-8 md:py-8 py-8 md:w-[400px] w-full md:h-[180px] h-[150px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.10),0px_4px_6px_-4px_rgba(0,0,0,0.10)]'>
      ...
      <section className='w-full h-full flex flex-col items-center justify-start lg:px-20 px-5 md:mt-40 mt-20 md:gap-10'>
        <div className='flex flex-col justify-start items-center w-full'>
          <h2 className='text-main-foreground text-center font-extrabold text-[48px]'>
            Convert your <span className='bg-gradient-to-r from-[#8D36EA] to-[#BB2CAB] bg-clip-text text-transparent'>2D Designs to 3D</span>
          </h2>
          <div className='flex flex-wrap md:gap-10 gap-10 justify-center items-start w-full md:mt-20 mt-10'>
            {models.map((model, index) => (
              <Link href={model.url} key={index} className='flex flex-col items-center justify-center gap-4 rounded-[40px] bg-primary md:w-[360px] w-[224px] md:h-[360px] h-[224px] overflow-hidden'>
          ...
          <h3 className='sm:text-[18px] text-center text-[12px] text-main-light md:mt-20 mt-10'>Transform any design into stunning 3D mockups in seconds</h3>
      ...
      <section className='w-full max-w-[1440px] flex lg:flex-row flex-col items-center justify-center md:px-20 px-5 md:mt-40 mt-20 md:gap-20' id="features">
        <h2 className='font-extrabold md:text-[48px] text-[36px] text-foreground md:text-left md:max-w-[300px] w-full text-center'>
          The Features <br className='hidden md:block' /> that <span className='bg-gradient-to-r from-[#783FEA] to-[#D02989] bg-clip-text text-transparent'>change</span> <br className='hidden md:block' /> Everything
        </h2>
        <div className='flex flex-col justify-center items-center w-full md:gap-8 gap-8 md:mt-0 mt-10'>
          <div className='flex rounded-[24px] dark:bg-main-foreground/20 dark:backdrop-blur-sm items-center justify-center gap-8 md:px-8 px-8 md:py-8 py-8 w-full md:h-[130px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.10),0px_4px_6px_-4px_rgba(0,0,0,0.10)]'>
            ...
            <div className='w-full flex flex-col justify-center items-center md:gap-2'>
              <h4 className='font-bold text-[24px] text-main-foreground text-left w-full'>Hyper-Realistic Fabric Simulation</h4>
              <h6 className='text-main-light text-left w-full'>Soft, stretchy, silky, textured—your designs will look and feel real.</h6>
            </div>
          </div>
          <div className='flex rounded-[24px] dark:bg-main-foreground/20 dark:backdrop-blur-sm items-center justify-center gap-8 md:px-8 px-8 md:py-8 py-8 w-full md:h-[120px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.10),0px_4px_6px_-4px_rgba(0,0,0,0.10)]'>
      ...
      <section className='w-full max-w-[1440px] md:px-20 px-5 flex flex-col items-center justify-start md:mt-40 mt-20'>
        <h2 className='text-main-foreground text-center font-extrabold md:text-[48px] text-[36px]'>
          Built for Creators who refuse to <span className='bg-gradient-to-r from-[#8D36EA] to-[#BB2CAB] bg-clip-text text-transparent'>blend in</span>
        </h2>
      ...
      <section className='w-full max-w-[1440px] h-full flex flex-col items-center justify-start md:px-20 px-5 md:mt-40 mt-20'>
        ...
        <h2 className='text-main-foreground text-center font-extrabold md:text-[48px] text-[36px]'>
          <span className='bg-gradient-to-r from-[#2563EB] via-[#9333EA] to-[#DB2777] bg-clip-text text-transparent'>2D Mockups</span>
        </h2>
        <h3 className='sm:text-[18px] text-[12px] text-center text-main-light md:mt-5 mt-5'>Professional quality mockups for every style and setting</h3>
        <div className='flex flex-wrap md:gap-10 gap-5 justify-center items-start w-full md:mt-20 mt-10'>
          {models2D.map((model, index) => (
            <div key={index} className='flex flex-col items-center justify-center gap-4 rounded-[40px] bg-primary md:w-[360px] w-[224px] md:h-[360px] h-[224px] overflow-hidden'>
        ...
        <span className='text-[18px] text-main-light md:mt-20 mt-10'>From flat lays to lifestyle shots - every angle covered</span>
      ...
      <section className='w-full max-w-[1440px] h-full flex flex-col items-center justify-start md:px-20 px-2.5 md:mt-40 mt-20'>
        <div className='flex flex-col justify-center items-center w-full md:gap-5'>
          ...
          <h2 className='text-main-foreground text-center font-extrabold sm:text-[48px] text-[24px] mt-5'>
            Designers Speak as <span className='bg-gradient-to-r from-[#2563EB] via-[#9333EA] to-[#DB2777] bg-clip-text text-transparent'>Results Show</span>
          </h2>
        </div>
        <div className='flex flex-col md:gap-5 justify-start items-center w-full md:px-10 md:mt-20'>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <div className="w-full sm:w-[300px] p-4 border rounded-xl shadow-sm">
              ...
              <p className="text-sm">It feels like having a full photography studio in my browser. The 3D realism is unbelievable.</p>
      ...
      <section className='w-full max-w-[1440px] h-full flex flex-col items-center justify-start md:px-20 px-2.5 md:mt-40 mt-20'>
        <div className='flex flex-col justify-center items-center w-full md:gap-5'>
          <div className='flex justify-center items-center gap-4 text-main-foreground text-center font-extrabold text-[48px]'>
            ...
            <span className='bg-gradient-to-r from-[#2563EB] via-[#9333EA] to-[#DB2777] bg-clip-text text-transparent'>FAQ&apos;s</span>
          </div>
        </div>
